        ...
        <div class="row justify-content-center">
            <div class="col-12 text-center mt-5 mb-5">
                <h1 class="display-4 mt-5 mb-0">
                    {{ __('ui.edit_article') }}: <span class="text-orange">{{ $article->title }}</span>
                </h1>
            </div>
        </div>
            ...
            <div class="col-12 col-md-6">
                ...
                <form method="POST" action="{{ route('article.update', $article) }}" class="auth-form">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="price" name="price" step="0.01" value="{{ old('price', $article->price) }}" required>
                    </div>
